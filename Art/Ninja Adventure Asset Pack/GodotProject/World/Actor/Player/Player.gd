...
var up:bool = false
var down:bool = false
var move_axis:Vector2 = Vector2(): set = set_move_axis
var speed:float = 90
var velocity:Vector2 = Vector2(): set = set_velocity
...
@onready var tween:Tween = $Sprite2D/Tween
...
func _physics_process(delta):
	push_velocity = push_velocity.lerp(Vector2.ZERO,0.1)
	set_velocity((velocity+push_velocity).floor())
	move_and_slide()
	velocity = velocity
